...
var createHmac = function (key, message) {
  return new Buffer(require('./crypto').default.hmac('sha1', key, message), 'hex');
}

var calculateSessionId = function (username, usersalt, serversecret, timestamp) {
